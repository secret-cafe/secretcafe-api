      ...
      if(!isUsers) {
        ...
        const menus = [
          // ---------------- Burgers ----------------
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830342/menu/1783830337368-241eeaf5-9cb1-4429-9860-f635f11e033a.jpg',
            available: true,
            submenu: [
          ...
          },
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830512/menu/1783830509485-d85188fe-a8ae-498a-a1bf-7d20f59aad04.jpg',
            available: true,
            submenu: [
              { name: 'Extra Cheese', price: 25, description: 'Cheese slice' },
          ...
          },
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830588/menu/1783830587213-9bd56d31-caab-440e-8778-623ff89b508b.jpg',
            available: true,
            submenu: [
          ...
          // ---------------- Pizza ----------------
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830708/menu/1783830702581-2d16bb72-e9f4-4456-9048-01f5a7c7c71c.jpg',
            available: true,
            submenu: [
          ...
          },
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830798/menu/1783830794841-91303c67-8fce-43e1-a318-dddf50010036.jpg',
            available: true,
            submenu: [
          ...
          },
          {
            ...
            imageUrl:
              'https://res.cloudinary.com/djrclalf9/image/upload/v1783830917/menu/1783830894059-15eb42d2-b9d7-408f-9414-4f342082d9bc.jpg',
            available: true,
            submenu: [
          ...
          },
          {
            ...
            available: true,
            submenu: [{ name: 'BBQ Sauce', price: 20, description: 'BBQ dip' }],
          },
          ...
          // ---------------- Cold Drinks ----------------
          {
            ...
            available: true,
            submenu: [{ name: 'Mint', price: 15, description: 'Fresh mint' }],
          },
          {
            category: 'Cold Beverages',
            name: 'Iced Tea',
            ...
            available: true,
            submenu: [{ name: 'Lemon', price: 10, description: 'Extra lemon' }],
          },
